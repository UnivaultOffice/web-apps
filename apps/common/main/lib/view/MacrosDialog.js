    ...
    Common.Views.MacrosDialog = Common.UI.Window.extend(_.extend({
        ...
        onAiMenu: function(menu, item) {
            ...
            if(item.value == 'create') {
                ...
                instruction = '' + 
                    'Create a macro for UnivaultOffice. ' + 
                    'The macro should be written specifically for the UnivaultOffice ' + editorName + '. ' +
                ...
                instruction = '' + 
                    'Convert macro for UnivaultOffice from VBA. ' +
                    'The macro should be written specifically for the UnivaultOffice ' + editorName + '. ' +
                    'Return only code with comments, as plain text without markdown. ' +
        ...
        onHelp: function() {
            window.open('https://api.univaultoffice.github.io/docs/plugin-and-macros/macros/getting-started/', '_blank')
        },
