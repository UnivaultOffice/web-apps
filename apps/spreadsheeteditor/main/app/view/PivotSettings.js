...
define([
    ...
    SSE.Views.PivotSettings = Backbone.View.extend(_.extend({
        ...
        onDragOver: function (listview, event) {
            if (event.originalEvent.dataTransfer.types[0] === 'univaultoffice' || (this.pivotIndex === -2 && (this.enterListView === 'pivot-list-filters' || this.enterListView === 'pivot-list-values')) ||
