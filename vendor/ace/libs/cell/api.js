 ...
 * @memberof ApiRange
 * @typeofeditors ["CSE"]
 * @param {ApiRange} [destination] - Specifies the new range to which the specified range will be copied. If this argument is omitted, Univaultoffice copies the range to the Clipboard.
 */
 ...
 * @memberof ApiRange
 * @typeofeditors ["CSE"]
 * @param {ApiRange} [destination] - Specifies the new range to which the specified range will be cuted. If this argument is omitted, Univaultoffice copies the range to the Clipboard.
 */
