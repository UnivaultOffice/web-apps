...
const config = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      __SUPPORT_EMAIL__: JSON.stringify(process.env.SUPPORT_EMAIL || 'support@univaultoffice.github.io'),
      __SUPPORT_URL__: JSON.stringify(process.env.SUPPORT_URL || 'https://support.univaultoffice.github.io'),
      __PUBLISHER_PHONE__: JSON.stringify(process.env.PUBLISHER_PHONE || '+371 633-99867'),
      __PUBLISHER_URL__: JSON.stringify(process.env.PUBLISHER_URL || 'https://univaultoffice.github.io'),
      __PUBLISHER_NAME__: JSON.stringify(process.env.PUBLISHER_NAME || 'Univault Technologies'),
      __APP_TITLE_TEXT__: JSON.stringify(process.env.APP_TITLE_TEXT ? process.env.APP_TITLE_TEXT : 'UNIVAULTOFFICE'),
      __COMPANY_NAME__: JSON.stringify(process.env.COMPANY_NAME ? process.env.COMPANY_NAME : 'UNIVAULTOFFICE'),
      __HELP_URL__: JSON.stringify(process.env.HELP_URL || 'https://helpcenter.univaultoffice.github.io'),
      __SALES_EMAIL__: JSON.stringify(process.env.SALES_EMAIL || 'sales@univaultoffice.github.io'),
    }),
